  ...
  <div className="flex items-center gap-5">
    <figure className="max-w-[200px] max-h-[200px]">
      <img
        src={Doc2}
        alt=""
        className="w-full" // Adjust the width and height values as needed
      />
    </figure>
    <div >
        <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] 
        lg:leading-7 font-semibold rounded">Surgeon</span>
        <h3 className=" text-headingColor text-[22px] 
        leading-9 mt-3 font-bold"> Larry Habakuk</h3>
      ...
      <p className=" text_para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">Larry Habakuk, an accomplished surgeon, brings expertise in advanced surgical techniques, delivering precision and compassionate care. </p>  
    </div>
  </div>
