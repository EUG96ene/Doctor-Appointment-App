...
const DoctorCard =({doctor})=>{
    ...
    return(
        <div className="p-1 lg:p-5">
            ...
            <h2 className="text-[18px] leading-[30px] 
            lg:text-[26px] lg:leading-9 text-headingColor font-[700] mt-3 lg:mt-5">{name}
            </h2>
        <div className="mt-2 lg:mt-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-[6x]">
                <span className="flex items-center gap-[6px] text-[14px] lg:leading-6 lg:text-[16px] 
                lg:leading-7 font-semibold text-headingColor">
                    <img src={Star} alt=""/>{avgRating}</span>
        ...
        <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
            <div>
                ...
                <p className="text-[14] leading-6 font-[400] text-textColor">
                    At {hospital}
                </p>
            </div>
            <Link to='/doctors' className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E]  flex items-center justify-content group hover:bg-primaryColor hover:border-none">
